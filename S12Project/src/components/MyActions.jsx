      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        <div className="flex items-center gap-4">
          <div className="text-pink-500 flex justify-center items-center rounded-full px-4 py-2">
            <span className="text-l shadow-[-5px_-5px_rgba(233,37,119,1)]"></span>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <button
            onClick={toggleTheme}
            className="flex items-center justify-center w-12 h-6 bg-gray-300 rounded-full p-1 cursor-pointer dark:bg-gray-700"
          >
            <div
